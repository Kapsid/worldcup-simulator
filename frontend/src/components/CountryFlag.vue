  ...
  computed: {
    ...
    nameToCode() {
      return {
        ...
        'North Macedonia': 'MKD', 'Albania': 'ALB', 'DR Congo': 'COD', 'Montenegro': 'MNE', 'Iceland': 'ISL',
        ...
        'Myanmar': 'MYA', 'Singapore': 'SIN', 'Dominican Republic': 'DOM', 'Fiji': 'FIJ', 'St. Kitts and Nevis': 'SKN',
        'New Caledonia': 'NCL', 'St. Lucia': 'LCA', 'St. Vincent and the Grenadines': 'VIN', 'Papua New Guinea': 'PNG', 'Vanuatu': 'VAN',
        'Grenada': 'GRN', 'Barbados': 'BRB', 'Belize': 'BLZ', 'South Sudan': 'SSD', 'Cambodia': 'CAM',
        'Nepal': 'NEP', 'Moldova': 'MDA', 'Guyana': 'GUY', 'Malta': 'MLT', 'Samoa': 'SAM',
        'Mauritius': 'MRI', 'Somalia': 'SOM', 'Djibouti': 'DJI', 'Macau': 'MAC', 'Bhutan': 'BTN',
        'Bangladesh': 'BAN', 'Dominica': 'DMA', 'São Tomé and Príncipe': 'STP', 'Laos': 'LAO', 'Seychelles': 'SEY',
        'Mongolia': 'MNG', 'Liechtenstein': 'LIE', 'Turks and Caicos Islands': 'TCA', 'Pakistan': 'PAK', 'Timor-Leste': 'TLS',
